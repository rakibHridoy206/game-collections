...
public class PCGamesFragment extends Fragment {
    ...
    private PCGamesAdapter pcGamesAdapter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        gameRef = userIdRef.child("PCGameInformation");
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_p_c_games, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        gameRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                pcGamesAdapter = new PCGamesAdapter(context, gameInfoList);
                LinearLayoutManager llm = new LinearLayoutManager(context);
                recyclerView.setLayoutManager(llm);
                recyclerView.setAdapter(pcGamesAdapter);
                pcGamesAdapter.notifyDataSetChanged();
            }
