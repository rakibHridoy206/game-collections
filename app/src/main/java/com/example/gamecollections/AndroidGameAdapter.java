...
public class AndroidGameAdapter extends RecyclerView.Adapter<AndroidGameAdapter.ViewHolder> {
    private Context context;
    private List<GameInfo> gameInfoList;
    private DatabaseReference rootRef;
    private DatabaseReference userRef;
    private DatabaseReference userIdRef;
    private DatabaseReference androidGameRef;
    private FirebaseUser currentUser;

    public AndroidGameAdapter(Context context, List<GameInfo> gameInfoList) {
        ...
        androidGameRef = userIdRef.child("AndroidGameInformation");
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AndroidGameAdapter.ViewHolder(itemView);
    }
